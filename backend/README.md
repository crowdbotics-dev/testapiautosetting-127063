...
## Project Structure
    ...
    ├── testapiautosetting_127063  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127063`
...
2. Clone this repo and `cd testapiautosetting_127063`
